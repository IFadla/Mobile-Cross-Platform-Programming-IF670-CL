  ...
  const addFriendHandler = () => {
	...
	const saveAddFriendHandler = () => {
		...
		if(selectedFriend === null) {
			friendsCtx.addFriend(enteredName.toString(), `https://randomuser.me/api/portraits/thumb/men/${Math.floor((Math.random() * 90) + 1)}.jpg`)
		}
		setIsAdding(false)
				...
				<IonContent>
					<IonGrid>
						<IonRow>
							<IonCol>
								<IonItem>
									...
									<IonInput type="text" value={selectedFriend?.name} placeholder="Change Name" onIonInput={(e) => setNameFriend((e.target as HTMLInputElement).value)} />
          			</IonItem>
							</IonCol>
						</IonRow>
						<IonRow className="ion-text-center">
							...
							<IonCol>
								<IonButton color="secondary" expand="block" onClick={saveEditFriendHandler}>Save</IonButton>
							</IonCol>
						</IonRow>
					</IonGrid>
				</IonContent>
				...
				<IonContent>
					<IonGrid>
						...
						<IonRow className="ion-text-center">
							...
							<IonCol>
								<IonButton color="secondary" expand="block" onClick={saveAddFriendHandler}>Save</IonButton>
							</IonCol>
						</IonRow>
					</IonGrid>
				</IonContent>
