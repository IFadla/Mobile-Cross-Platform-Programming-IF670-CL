import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonButton, IonItem, IonLabel, IonInput, IonList, IonAvatar } from '@ionic/react';
...
const Home: React.FC = () => {
  ...
  const prodi = useRef<HTMLInputElement>(null)
          ...
          {students.map(student => (
            <IonItem>
              <IonAvatar slot="start">
                <img src={student.fotoUrl} alt="gambar" />
              </IonAvatar>
              <IonLabel>
                {student.nim}<br/>
                {student.nama}<br/>
